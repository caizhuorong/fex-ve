...
function loginInit() {
    ...
    parameter['welcome'] = '<span class="top_bc_tit">您好，欢迎来到最佳东方！</span> <a href="http://i.veryeast.cn/user/login/?redirect=' + encodeURIComponent(location.href) + '" class="color_main" target="_self">请登录</a> <a href="http://i.veryeast.cn/user/register/" target="_self">免费注册简历</a> <a href="http://vip.veryeast.cn/Reg.asp/" target="_self">注册企业会员</a>';
